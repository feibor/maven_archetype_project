$(document).ready(function () {
    ...
    //add by feifei
    var context =window.popBerry.context.getBasePath();
    ...
    function switchTheme(themeName) {
        if (themeName == 'classic') {
            $('#bs-css').attr('href', context+'bower_components/bootstrap/dist/css/bootstrap.min.css');
        } else {
            $('#bs-css').attr('href', context+'css/bootstrap-' + themeName + '.min.css');
        }
